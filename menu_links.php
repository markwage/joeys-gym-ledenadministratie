...
if (isset($_COOKIE['ID_leden'])) {
	...
	echo '<li><a href="leden.php?aktie=dispAktiefOnbeperkt">Aktieve leden - Onbeperkt</a></li>';
	echo '<li><a href="leden.php?aktie=dispAktiefEenmaal">Aktieve leden - Eenmaal</a></li>';
	...
	echo '<li><a href="leden.php?aktie=dispStripkrt">Leden met een strippenkaart</a></li>';
